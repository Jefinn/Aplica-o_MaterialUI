...
const ListarTarefa = () => {
  ...
  const Title = () => {
    React.useEffect(() => {
      document.title("Gerenciamento de Projetos");
    }, []);
    return null;
  };
  ...
  return (
    <>
      ...
      sx={{
        ...
        <img
          src="https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExaXIyNnF1Yjk3NDlsMDIwMDRyMDR6OXB0bWxxYjVtM3dob284NGs2cyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9ZQ/e0Uiyu70TXQAALdKP9/giphy.gif"
          alt="Gif Planeta"
        />
      </Box>
    </>
